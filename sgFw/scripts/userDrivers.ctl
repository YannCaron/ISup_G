...
dyn_dyn_string main()
{
  ...
  // names
  dds[1]=makeDynString("TCP Communication", "Serial Modbus", "MQ Driver");

  // types
  dds[2]=makeDynString("tcpComm", "serialMod", "mqDriver");

  // drivers
  dds[3]=makeDynString("TCPCOMM", "SERIALMOD", "MQDRIVER");
